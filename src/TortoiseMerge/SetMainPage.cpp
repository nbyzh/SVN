...
// Copyright (C) 2006-2010, 2012-2014, 2016, 2018, 2020-2022, 2024 - TortoiseSVN
    ...
    , m_themeCallbackId(0)
{
    ...
    m_nTabSize             = m_nTabSize = std::min(TABSIZE_MAX, std::max(TABSIZE_MIN, static_cast<int>(m_regTabSize)));
