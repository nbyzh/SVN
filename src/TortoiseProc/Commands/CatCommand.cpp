...
// Copyright (C) 2007-2008, 2010, 2014, 2018, 2021-2024 - TortoiseSVN
...
bool CatCommand::Execute()
{
    ...
    CString pegRevision = parser.HasVal(L"pegrev") ? parser.GetVal(L"pegrev") : parser.GetVal(L"pegrevision");
