...
# error message.
#
# $HeadURL: https://svn.apache.org/repos/asf/subversion/tags/1.14.5/contrib/hook-scripts/detect-merge-conflicts.sh $
# $LastChangedDate: 2013-04-11 10:38:26 +0800 (周四, 11 4月 2013) $
